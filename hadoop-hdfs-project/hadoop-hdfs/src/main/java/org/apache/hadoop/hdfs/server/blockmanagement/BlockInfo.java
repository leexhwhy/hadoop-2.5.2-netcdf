...
public class BlockInfo extends Block implements LightWeightGSet.LinkedElement {
  ...
  private boolean isModifiedBlock;  
  ...
  public BlockInfo(Block blk, int replication, boolean isModifiedBlock ){
    super(blk);
    this.triplets = new Object[3*replication];
    this.isModifiedBlock = isModifiedBlock;
    this.bc = null;
  }
  ...
  protected BlockInfo( BlockInfo from, boolean isModifiedBlock ) {
    this(from, from.bc.getBlockReplication());
    this.bc = from.bc;
    this.isModifiedBlock = isModifiedBlock;
  }
  ...
  public boolean getIsModifiedBlock() {
    return this.isModifiedBlock;
  }

  public void setIsModifiedBlock( boolean isModifiedBlock ){
    this.isModifiedBlock = isModifiedBlock;
  }
