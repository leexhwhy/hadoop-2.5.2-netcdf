 ...
 */
public class NetCDFReaderWithMetaPartToMemoryNoMultiSplit implements RecordReader<Text, NetCDFArrayWritable> {
    private static final Log LOG
            = LogFactory.getLog(NetCDFReaderWithMetaPartToMemoryNoMultiSplit.class.getName());
    ...
    public NetCDFReaderWithMetaPartToMemoryNoMultiSplit(Configuration job,
        ...
        if (pos < end) {
            ...
            try{
                ...
                while(pos < end) {
                    ...
                    chunk = (ArrayFloat.D3)(ncFile.readSection("rsut(" + pos + ":" + pos + ","+startLat+":"+(endLat-1)+","+startLon+":"+(endLon-1)+")"));
