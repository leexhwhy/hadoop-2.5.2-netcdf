 ...
 */
public class NetCDFOutputFormatCompact2Reduced<Text, List> extends FileOutputFormat<Text, List> {
    ...
    public NetCDFOutputFormatCompact2Reduced(){
        super();
    }
        ...
        public synchronized void write(Text key, List value)
            ...
            try {
                ...
                for( int i = 0; i < latIndexesSize; i++ ){
                    ...
                    dataLat.setDouble(i, Double.valueOf(Integer.valueOf(currentCumulativeLat)*numChunksPerKey+i));
                }
                ...
                for (int i = 0; i < latIndexesSize; i++) {
                    for (int j = 0; j < shape[1]; j++) {
                        idx.set(i, j);
                        if( j == 0 ){
                            dataLatBnds.setDouble(idx, (double)(Integer.valueOf(currentCumulativeLat)*numChunksPerKey+i) - 0.5);
                        }else if( j == 1 ){
                ...
                for (int i = 0; i < shape[0]; i++) {
                    for (int j = 0; j < shape[1]; j++) {
                        idx.set(i, j);
                        if( j == 0 ){
                            dataLonBnds.setDouble(idx, (double)i - 0.5);
                        }else if( j == 1 ){
                            dataLonBnds.setDouble(idx, (double)i + 0.5);
                        }
