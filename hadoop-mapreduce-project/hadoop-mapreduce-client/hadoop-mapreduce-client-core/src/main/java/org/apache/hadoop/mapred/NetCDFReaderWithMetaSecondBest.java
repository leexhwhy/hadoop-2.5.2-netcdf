 ...
 */
public class NetCDFReaderWithMetaSecondBest implements RecordReader<Text, NetCDFArrayWritable> {
    private static final Log LOG
            = LogFactory.getLog(NetCDFReaderWithMetaSecondBest.class.getName());
    ...
    public NetCDFReaderWithMetaSecondBest(Configuration job,
