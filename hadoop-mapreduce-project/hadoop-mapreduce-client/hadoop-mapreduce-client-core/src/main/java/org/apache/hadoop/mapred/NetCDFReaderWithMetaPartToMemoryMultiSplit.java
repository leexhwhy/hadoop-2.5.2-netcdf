        ...
        if (pos < end.get(currChunk)) {
            ...
            try{
                ...
                while(pos < end.get(currChunk)) {
                    ...
                    if( endLat.get(currChunk) == -1 ) endLat.set(currChunk,  (long)(v.get(currChunk).getDimensions().get(1).getLength()));
                    if( startLon.get(currChunk) == -1 ) startLon.set(currChunk, (long)0);
                    if( endLon.get(currChunk) == -1 ) endLon.set(currChunk, (long)(v.get(currChunk).getDimensions().get(2).getLength()));
