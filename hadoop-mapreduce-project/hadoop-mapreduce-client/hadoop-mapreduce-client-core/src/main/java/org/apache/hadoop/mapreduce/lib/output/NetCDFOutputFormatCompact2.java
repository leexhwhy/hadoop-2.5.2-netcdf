...
public class NetCDFOutputFormatCompact2<Text, List> extends FileOutputFormat<Text, List> {
    ...
    protected static class NetCDFRecordWriterCompact2<Text, List> extends RecordWriter<Text, List> {
        ...
        public NetCDFRecordWriterCompact2( FileSystem _fs, TaskAttemptContext _job ) {
