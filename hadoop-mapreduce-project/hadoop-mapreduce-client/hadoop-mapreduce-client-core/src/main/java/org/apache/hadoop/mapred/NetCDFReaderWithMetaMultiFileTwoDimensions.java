 ...
 */
public class NetCDFReaderWithMetaMultiFileTwoDimensions implements RecordReader<Text, NetCDFArrayWritable> {
    ...
    private List<Long> secondDimStart = new LinkedList<Long>();
    private List<Long> secondDimEnd = new LinkedList<Long>();
    ...
    public NetCDFReaderWithMetaMultiFileTwoDimensions(Configuration job,
