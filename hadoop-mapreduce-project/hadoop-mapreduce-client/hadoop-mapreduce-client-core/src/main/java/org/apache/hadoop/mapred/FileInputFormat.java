...
public abstract class FileInputFormat<K, V> implements InputFormat<K, V> {
  ...
  protected FileStatus[] listStatus(JobConf job) throws IOException {
    ...
    if (dirs.length == 0) {
      //System.out.println( "[SAMAN] FileInputFormat.listStatus No input path!" );
      //LOG.info( "[SAMAN] FileInputFormat.listStatus No input path!" );
    ...
    if (numThreads == 1) {
      //System.out.println( "[SAMAN] FileInputFormat.listStatus numThreads=1" );
      //LOG.info( "[SAMAN] FileInputFormat.listStatus numThreads=1" );
	...
	//System.out.println( "[SAMAN] FileInputFormat.listStatus interrupt exception" );
	//LOG.info( "[SAMAN] FileInputFormat.listStatus interrupt exception" );
    ...
    if (LOG.isDebugEnabled()) {
      LOG.info("Time taken to get FileStatuses: " + sw.elapsedMillis());
    }
